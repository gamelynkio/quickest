        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "28px" }}>
          <div>
            <h1 style={{ fontSize: "22px", fontWeight: 800, color: "#0f172a", margin: 0 }}>
              {editingTest ? "Test bearbeiten" : "Neuen Test erstellen"}
            </h1>
            ...
            <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", marginTop: "12px" }}>
              {gradingScale.map((g, i) => (
                <div key={i} style={{ background: "#f8fafc", borderRadius: "8px", padding: "8px 12px", border: "1px solid #e2e8f0", fontSize: "13px" }}>
                  ...
                  <input type="number" value={g.minPercent}
                    onChange={e => {
                      const updated = [...gradingScale];
                      updated[i].minPercent = Number(e.target.value);
          ...
          <div key={q.id} style={{ background: "#fff", borderRadius: "16px", padding: "22px", border: "1px solid #e2e8f0", marginBottom: "14px" }}>
            ...
            {q.type === "open" && (
              <div style={{ marginTop: "10px", background: "#f0f7ff", borderRadius: "8px", padding: "10px 14px", fontSize: "13px", color: "#2563a8", border: "1px solid #bfdbfe" }}>
                🤖 Diese Aufgabe wird automatisch von der KI bewertet. Du kannst die Bewertung anschließend anpassen.
              </div>
            )}

            {q.type === "fill_blank" && (
              <div style={{ marginTop: "10px", fontSize: "13px", color: "#64748b" }}>
                Nutze <code style={{ background: "#f1f5f9", padding: "1px 5px", borderRadius: "4px" }}>[Lücke]</code> in der Aufgabenstellung für Lücken.
              </div>
            )}
